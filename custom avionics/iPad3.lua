...
-- note FG has 3568 fot TR rpm and rrpm="386" for main rotor (ratio: 0.108)
--  JB-Fenestron.afl ... +/- 20deg ClL up to 0.4
-- ?? sim/flightmodel/forces/fside_prop	float	y	Newtons	force sideways by all engines on the ACF.  Override with override_engines

-- NLF(1)-0215F (laminar flow).afl for tail fin??
